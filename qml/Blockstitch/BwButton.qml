...
Button {
    ...
    contentItem: Row {
        ...
        LucideIcon { visible: control.iconName.length > 0; name: control.iconName; filled: control.iconFilled; color: control.danger ? Theme.danger : Theme.text; width: 16; height: 16; anchors.verticalCenter: parent.verticalCenter }
    ...
    background: Rectangle {
        ...
        color: control.down ? (control.primary ? "#087bd4" : "#292a2d")
                            : control.hovered ? (control.primary ? Theme.accentHover : "#3b3c40")
                                              : (control.primary ? Theme.accent : Theme.panelRaised)
        border.color: control.danger ? Theme.danger : (control.primary ? "#50b2ff" : Theme.border)
